  ...
  return (
    <div className={styles.actions}>
      <button className={styles.actions_button}>
        ...
        <span className={styles.visible_1024}>Статистика публикации</span>
      </button>
      <button className={styles.actions_button}>
        <svg
        ...
        <span className={styles.visible_1024}>Поделиться</span>
      </button>
      <button className={styles.actions_button}>
        <svg
        ...
        <span className={styles.visible_1024}>Удалить</span>
      </button>
    </div>
  );
}
